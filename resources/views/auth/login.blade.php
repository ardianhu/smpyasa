<x-layout.auth>
    ...
    <div class="flex justify-center items-center min-h-screen bg-[url('/assets/images/map.svg')] dark:bg-[url('/assets/images/map-dark.svg')] bg-cover bg-center">
        <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
            ...
            <p class="mb-7">Masukkan Email dan password anda</p>
            ...
            <div class="flex items-center p-3.5 rounded text-danger bg-danger-light dark:bg-danger-dark-light">
                <span class="ltr:pr-2 rtl:pl-2"><strong class="ltr:mr-1 rtl:ml-1">Error!</strong>{{ $message }}.</span>
            ...
            <p class="text-center">Dont't have an account ? <a href="/auth/boxed-signup" class="text-primary font-bold hover:underline">Sign Up</a></p> -->
        </div>
    </div>
