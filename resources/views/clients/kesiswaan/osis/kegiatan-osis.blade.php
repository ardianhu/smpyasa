...
<x-layout.default>
    ...
    <div x-data="home">
        ...
        <x-header-banner :background-image="'/assets/images/header.jpg'" :title="'KEGIATAN OSIS'" />
        <div class="container">
            ...
            <div class="py-10">
                <div class="mb-12 mx-0 lg:mx-4 bg-white dark:bg-[#0e1726] rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-lg">
                    <h2 class="text-3xl font-bold text-green-700 mb-6 text-center">Kegiatan Osis</h2>
                    <style>
                        .content-pages p {
                            margin-bottom: 1rem;
                            text-indent: 50px;
