    ...
    <nav x-data="sidebar" class="sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300">
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'user' }" @click="activeDropdown === 'user' ? activeDropdown = null : activeDropdown = 'user'">
                        <div class="flex items-center">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'user'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/dashboard/user">Kelola User</a>
                        </li>
                        <li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'post' }" @click="activeDropdown === 'post' ? activeDropdown = null : activeDropdown = 'post'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Post</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'post' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'post'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/dashboard/post">Kelola Post</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'galeri' }" @click="activeDropdown === 'galeri' ? activeDropdown = null : activeDropdown = 'galeri'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Galeri</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'galeri' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'galeri'" x-collapse class="sub-menu text-gray-500">
                        <li>
